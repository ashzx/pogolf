const generations: string[] = [
    ...
    "Gen 5 - Unova",
    "Gen 6 - Kalos",
    "Gen 7 - Alola & Pokemon Go Exclusives",
    "Gen 8 - Galar & Hisui",
    "Gen 9 - Paldea & Kitakami",
];
...
const golfScores: Record<string, string> = {
    "-3": 'an Albatross',
    "-2": 'an Eagle',
    "-1": 'a Birdie',
    "0": 'a Par',
...
const golfScoreEmojis: Record<string, string> = {
    "-3": '🦩',
    "-2": '🦅',
    "-1": '🐦',
    "0": '⛳',
...
export { generations, pokemon, golfScores, golfScoreEmojis }